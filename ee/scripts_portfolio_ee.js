document.addEventListener("DOMContentLoaded", function() {
    ...
    const projects = [
        ...
        },
        {
            ...
            galleryLink: `/${repoName}/ee/Project5_ee.html`
        },
        {
            year: "2021",
            ...
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project6_ee.html`
        },
        {
            year: "2022",
            ...
            client: "AS FENSTER ALUMIINIUM/Tallinn",
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project7_ee.html`
        },
        {
            year: "2023",
            ...
            client: "AS FENSTER ALUMIINIUM/Tallinn",
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project8_ee.html`
        },
        {
            year: "2023",
            ...
            client: "AS FENSTER ALUMIINIUM/Tallinn",
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project9_ee.html`
        },
        {
            year: "2024",
            ...
            client: "AS FENSTER ALUMIINIUM/Tallinn",
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project10_ee.html`
        },
        {
            year: "2024",
            ...
            client: "AS FENSTER ALUMIINIUM/Tallinn",
            description: `AS FENSTER ALUMIINIUM/Tallinn<br>Fassaadi klaasimine, vitraažid ja seinad.`,
            galleryLink: `/${repoName}/ee/Project11_ee.html`
        },
        {
            year: "2024",
            ...
            galleryLink: `/${repoName}/ee/Project12_ee.html`
        },
        {
            year: "2024",
            ...
            galleryLink: `/${repoName}/ee/Project13_ee.html`
        }
    ];
